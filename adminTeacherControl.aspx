<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="adminTeacherControl.aspx.cs" Inherits="UAS.adminTeacherControl" %>
                        ...
                        <asp:GridView class="table border-0 table-striped  table-responsive" ID="eventGrid" runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="OnPageIndexChanging" PageSize="10" >
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnSelect" runat="server" CommandArgument='<%#Eval("t_id") %>' OnClick="btnSelect_Click"> <%#Eval("t_name")  %> </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                
                                <asp:BoundField DataField="status" HeaderText="Status" />
                               
                                <asp:BoundField DataField="t_phone" HeaderText="Phone" />
                                <asp:BoundField DataField="t_mail" HeaderText="Email" />
