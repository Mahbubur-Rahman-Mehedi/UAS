<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="loginStudent.aspx.cs" Inherits="UAS.loginStudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <section id="login">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Login as Student</h1>
                <br />
                ...
                <p class="lead">Don't have an account? <a href="studentRegistration.aspx"><b>Register</b></a></p>
