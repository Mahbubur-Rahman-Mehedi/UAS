<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="studentRegistration.aspx.cs" Inherits="UAS.studentRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container justify-content-center mt-5 mb-5 border rounded p-5" style="border:1px solid black !important; border-radius:25px !important; color: black; box-shadow: 2px 2px 20px grey; background-color:aliceblue; background-image: radial-gradient(rgba(185, 206, 222, 0.6), rgba(194, 226, 221, 0.4));">
        ...
        <br />
       <h2 style="text-align:center;">Register as a Student</h2>
        <br /> <br />
        ...
        <div class="form-row justify-content-around">
          ...
          <div class="form-row justify-content-around">
            <div class="form-group col-md-12">
                ...
                <asp:TextBox ID="txtPaddress" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        </div>
